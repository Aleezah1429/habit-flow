...
git checkout main
git pull
git checkout -b feature/phase-N-<short-name> e.g. git checkout -b feature/phase-2-daily-checkin

# ── STEP 2: spec the feature (in Claude Code) ───────────────
/feature-spec <short-name> e.g. /feature-spec daily-checkin
...
### "If Find Bug then Will I change`validations.md` or`requirements.md`?"
...
### "Should I add Library or use useState?"
...
If feature branch made as default then. Fix: `Settings → Branches → Default branch → main`.
